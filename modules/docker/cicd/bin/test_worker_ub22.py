...
cmdlist += ['-v',"%s:/home/workerub22/.ssh/id_rsa:ro"%str(private_key)]
cmdlist += ['-v',"%s:/home/workerub22/.ssh/id_rsa.pub:ro"%str(public_key)]

if orkid_dir!=None:
  cmdlist += ['-v',"%s:/home/workerub22/orkid"%str(orkid_dir)]

cmdlist += ['-it','obtcicd/worker_jammy','/bin/bash']
